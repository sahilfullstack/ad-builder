...
<body class="{{ isset($bodyClass) ? $bodyClass : '' }}">    
    ...
    <div id="workspace">
        ...
        <div class="body">
            ...
            <div id="text-4" style="
                background-color: {{ empty(array_get($readableComponents, 'text-4')['background_color']) ? 'transparent' : array_get($readableComponents, 'text-4')['background_color'] }};
                display: flex;
                align-items: {{ align_to_flex_rule(array_get($readableComponents, 'text-4.valign')) }};
                justify-content: {{ align_to_flex_rule(array_get($readableComponents, 'text-4.halign')) }};
                text-align: {{ array_get($readableComponents, 'text-4.halign') }};
            ">
            ...
            <div id="text-5" style="
                background-color: {{ empty(array_get($readableComponents, 'text-5')['background_color']) ? 'transparent' : array_get($readableComponents, 'text-5')['background_color'] }};
                display: flex;
                align-items: {{ align_to_flex_rule(array_get($readableComponents, 'text-5.valign')) }};
                justify-content: {{ align_to_flex_rule(array_get($readableComponents, 'text-5.halign')) }};
                text-align: {{ array_get($readableComponents, 'text-5.halign') }};
            ">
            ...
            <div id="text-6" style="
                background-color: {{ empty(array_get($readableComponents, 'text-6')['background_color']) ? 'transparent' : array_get($readableComponents, 'text-6')['background_color'] }};
                display: flex;
                align-items: {{ align_to_flex_rule(array_get($readableComponents, 'text-6.valign')) }};
                justify-content: {{ align_to_flex_rule(array_get($readableComponents, 'text-6.halign')) }};
                text-align: {{ array_get($readableComponents, 'text-6.halign') }};
            ">
