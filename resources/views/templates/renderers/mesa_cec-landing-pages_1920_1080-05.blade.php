...
<body class="{{ isset($bodyClass) ? $bodyClass : '' }}">    
    ...
    <div id="workspace">
        ...
        <div class="body">
            ...
            @if(! is_null(array_get($readableComponents, 'twitter-url._value')))
            ...
            @if(! is_null(array_get($readableComponents, 'instagram-url._value')))
            <div class="social-logo-image2">
            ...
            @if(! is_null(array_get($readableComponents, 'facebook-url._value')))
            <div class="social-logo-image3">
