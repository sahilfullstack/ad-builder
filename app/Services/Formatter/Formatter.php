<?php namespace App\Services\Formatter;

use InvalidArgumentException;
use App\Services\Formatter\Formatter as FFormatter;
use App\Services\Formatter\Parsers\ArrayParser;
use App\Services\Formatter\Parsers\CsvParser;
use App\Services\Formatter\Parsers\JsonParser;
use App\Services\Formatter\Parsers\XmlParser;
use App\Services\Formatter\Parsers\YamlParser;
...
class Formatter
{
    ...
    public static function make($data, $type, $delimiter = null)
    {
        if (in_array($type, self::$supportedTypes)) {
            ...
            return new FFormatter($parser, $type);
        }
